        ...
        <div class="max-w-6xl mx-auto">
            <div class="mb-8">
                <div class="flex justify-between items-center mb-2">
                    <span class="text-sm font-medium text-gray-600">Étape 4 sur 10</span>
            ...
            <div class="bg-white rounded-lg shadow-lg p-8 mb-8">
                ...
                <form method="POST" action="{{ route('form.submit', 'roofWorkType') }}">
                    ...
                    <div class="flex justify-between mt-8">
                        <a href="{{ route('form.previous', 'roofWorkType') }}" class="bg-gray-500 text-white px-6 py-3 rounded-lg hover:bg-gray-600 transition">
