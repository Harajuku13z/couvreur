        ...
        <div class="max-w-6xl mx-auto">
            <div class="mb-8">
                <div class="flex justify-between items-center mb-2">
                    <span class="text-sm font-medium text-gray-600">Étape 6 sur 10</span>
                ...
                <form method="POST" action="{{ route('form.submit', 'isolationWorkType') }}">
                    ...
                    <div class="grid grid-cols-2 md:grid-cols-4 gap-6">
                        ...
                        <label for="isolation_{{ $value }}" class="cursor-pointer">
                            ...
                            <div class="work-option rounded-lg p-6 text-center transition">
                    ...
                    <div class="flex justify-between mt-8">
                        <a href="{{ route('form.previous', 'isolationWorkType') }}" class="bg-gray-500 text-white px-6 py-3 rounded-lg hover:bg-gray-600 transition">
