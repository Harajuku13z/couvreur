...
<meta property="og:image" content="{{ Storage::url($service['og_image'] ?? $service['featured_image']) }}">
...
@if($service['og_image'] ?? $service['featured_image'])
<meta name="twitter:image" content="{{ Storage::url($service['og_image'] ?? $service['featured_image']) }}">
@endif
@endpush
...
<div class="min-h-screen bg-gray-50">
    ...
    <section class="relative py-20 text-white overflow-hidden">
        ...
        <div class="absolute inset-0 bg-cover bg-center bg-no-repeat" 
             style="background-image: url('{{ Storage::url($service['featured_image']) }}'); filter: blur(2px); transform: scale(1.1);"></div>
