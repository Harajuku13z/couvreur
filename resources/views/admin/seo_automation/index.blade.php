...
<div class="container mx-auto px-4 py-6 md:py-8">
    ...
    <div class="bg-white rounded-lg shadow-md p-6 mb-6">
        ...
        <form action="{{ route('admin.seo-automation.save-config') }}" method="POST" class="space-y-6">
            @csrf
            ...
            <div class="border-b border-gray-200 pb-4">
                <h3 class="text-lg font-medium text-gray-900 mb-3">
                    <i class="fas fa-robot mr-2 text-green-600"></i>ChatGPT / OpenAI
                </h3>
                <div class="space-y-4">
                    <div class="flex items-center">
                        <input type="checkbox" 
                               ...
                               value="1"
                               {{ old('chatgpt_enabled', $apiConfig['chatgpt_enabled']) ? 'checked' : '' }}
                               class="rounded border-gray-300 text-blue-600 focus:ring-blue-500">
                        <label for="chatgpt_enabled" class="ml-2 text-sm font-medium text-gray-700">
                            Activer ChatGPT
                        </label>
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <select id="chatgpt_model" 
                                name="chatgpt_model" 
                                class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
                            <option value="gpt-3.5-turbo" {{ old('chatgpt_model', $apiConfig['chatgpt_model']) == 'gpt-3.5-turbo' ? 'selected' : '' }}>GPT-3.5 Turbo</option>
                            <option value="gpt-4" {{ old('chatgpt_model', $apiConfig['chatgpt_model']) == 'gpt-4' ? 'selected' : '' }}>GPT-4</option>
                            <option value="gpt-4-turbo" {{ old('chatgpt_model', $apiConfig['chatgpt_model']) == 'gpt-4-turbo' ? 'selected' : '' }}>GPT-4 Turbo</option>
                            <option value="gpt-4o" {{ old('chatgpt_model', $apiConfig['chatgpt_model']) == 'gpt-4o' ? 'selected' : '' }}>GPT-4o</option>
                        </select>
                    </div>
                </div>
            </div>
            ...
            <div class="border-b border-gray-200 pb-4">
                <h3 class="text-lg font-medium text-gray-900 mb-3">
                    <i class="fas fa-brain mr-2 text-purple-600"></i>Groq (Fallback)
                </h3>
                <div class="space-y-4">
                    <div>
                    ...
                    <div>
                        ...
                        <select id="groq_model" 
                                name="groq_model" 
                                class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
                            <option value="llama-3.1-8b-instant" {{ old('groq_model', $apiConfig['groq_model']) == 'llama-3.1-8b-instant' ? 'selected' : '' }}>Llama 3.1 8B Instant</option>
                            <option value="llama-3.1-70b-versatile" {{ old('groq_model', $apiConfig['groq_model']) == 'llama-3.1-70b-versatile' ? 'selected' : '' }}>Llama 3.1 70B Versatile</option>
                            <option value="mixtral-8x7b-32768" {{ old('groq_model', $apiConfig['groq_model']) == 'mixtral-8x7b-32768' ? 'selected' : '' }}>Mixtral 8x7B</option>
                        </select>
                    </div>
                </div>
            </div>
            ...
            <div>
                <h3 class="text-lg font-medium text-gray-900 mb-3">
                    <i class="fab fa-google mr-2 text-red-600"></i>Google Search Console / Indexing
                </h3>
                <div>
                    <label for="google_credentials" class="block text-sm font-medium text-gray-700 mb-2">
                    ...
                    <textarea id="google_credentials" 
                              ...
                              class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 font-mono text-xs">{{ old('google_credentials', $apiConfig['google_credentials']) }}</textarea>
                    <p class="text-xs text-gray-500 mt-1">JSON des credentials du Service Account Google. Format requis: service_account</p>
                </div>
            </div>
