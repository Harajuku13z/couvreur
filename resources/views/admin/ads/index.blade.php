...
<div class="max-w-6xl mx-auto py-10">
    <div class="flex justify-between items-center mb-6">
        ...
        <div class="space-x-3">
            <a href="{{ route('admin.ads.bulk-ads') }}" class="bg-orange-600 text-white px-4 py-2 rounded hover:bg-orange-700">
                <i class="fas fa-magic mr-2"></i>Génération en Masse
            </a>
            ...
            <a href="{{ route('ads.keyword-cities') }}" class="bg-purple-600 text-white px-4 py-2 rounded hover:bg-purple-700">
